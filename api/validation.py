    ...
    "parts.csv": pa.DataFrameSchema(
        {
            ...
            "active": pa.Column(str, nullable=True, coerce=True),
            "virtual": pa.Column(str, nullable=True, coerce=True),
        },
        strict=True,
    ),
    ...
    "companies.csv": pa.DataFrameSchema(
        {
            "id": pa.Column(str, coerce=True),
            "name": pa.Column(str, pa.Check.str_length(min_value=1), coerce=True),
            "is_supplier": pa.Column(str, nullable=True, coerce=True),
            "is_manufacturer": pa.Column(str, nullable=True, coerce=True),
            "is_customer": pa.Column(str, nullable=True, coerce=True),
        },
        strict=True,
    ),
}
