...
## PR-13.1 — Cloud Run live demo (blocked)

| Artifact | Purpose |
|----------|---------|
| `PR13_1_CLOUD_RUN_LIVE_DEMO.md` | PR-13.1 deploy attempt: contract inspection PASS, `gcloud` missing BLOCKED |
...
| Live Cloud Run / ECS / Azure deploy | **No** | PR-13.1 blocked (`gcloud` missing); templates — see `docs/cloud/` |
